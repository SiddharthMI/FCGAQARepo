...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            MergedUserCodeMethod(repo.ApplicationUnderTest.NPFPolicySubmit_CheckInfo, repo.ApplicationUnderTest.NPFPolicySubmit_OnlineInfo, PaymentMethod);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 1m to exist. Associated repository item: 'ApplicationUnderTest.LblBusinessName'", repo.ApplicationUnderTest.LblBusinessNameInfo, new ActionTimeout(60000), new RecordItemIndex(6));
