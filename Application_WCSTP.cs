...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Application_WCSTP recording.
    /// </summary>
    [TestModule("92075a16-3683-4e15-8714-f0946cbddd92", ModuleType.Recording, 1)]
    public partial class Application_WCSTP : ITestModule
    {
        /// <summary>
        ...
        static Application_WCSTP instance = new Application_WCSTP();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Application_WCSTP()
        {
        ...
        /// </summary>
        public static Application_WCSTP Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("5f11a7e7-d661-4d55-ab94-ade09f37cea8")]
        ...
        /// </summary>
        [TestVariable("7f0450ef-8569-403f-ab3c-53c76dc95177")]
        ...
        /// </summary>
        [TestVariable("65815d31-8189-4dc7-a2ba-67d09f3d79e6")]
        ...
        /// </summary>
        [TestVariable("cf9ec487-06ce-453f-8eec-54fd22dd9cf1")]
        ...
        /// </summary>
        [TestVariable("e5ee8d0e-6e91-4477-923b-456c3556a94b")]
        ...
        /// </summary>
        [TestVariable("ab37f334-fc33-4a68-83ef-c5d63c4e6270")]
        ...
        /// </summary>
        [TestVariable("b640351f-b587-4438-bdf2-18ae74936960")]
        ...
        /// </summary>
        [TestVariable("b350db63-f306-4e66-976c-10e691ce10da")]
        ...
        /// </summary>
        [TestVariable("16fee528-4d8f-4fc9-9a7b-2603cdff8a40")]
        ...
        /// </summary>
        [TestVariable("7a54b25a-e743-4cea-a671-66ce4310d13f")]
        ...
        /// </summary>
        [TestVariable("2aba99db-3b81-4c79-b73b-9911137e7f1e")]
        ...
        /// </summary>
        [TestVariable("ec03f0f6-929c-4116-9f97-0b41dbec1012")]
        ...
        /// </summary>
        [TestVariable("143d649d-c6f1-445b-88c8-64bada54b6a2")]
        ...
        /// </summary>
        [TestVariable("054e9d87-425c-4098-aa8c-b2740a9a0925")]
        ...
        /// </summary>
        [TestVariable("be80dded-5c6d-4704-8d1a-b899db3a8a40")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtMainInsuredContactName' at Center.", repo.ApplicationUnderTest.TxtMainInsuredContactNameInfo, new RecordItemIndex(26));
            repo.ApplicationUnderTest.TxtMainInsuredContactName.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$App_ContactName' with focus on 'ApplicationUnderTest.TxtMainInsuredContactName'.", repo.ApplicationUnderTest.TxtMainInsuredContactNameInfo, new RecordItemIndex(27));
            repo.ApplicationUnderTest.TxtMainInsuredContactName.PressKeys(App_ContactName);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtMainInsuredPhone' at Center.", repo.ApplicationUnderTest.TxtMainInsuredPhoneInfo, new RecordItemIndex(28));
            repo.ApplicationUnderTest.TxtMainInsuredPhone.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$App_Phone_Num' with focus on 'ApplicationUnderTest.TxtMainInsuredPhone'.", repo.ApplicationUnderTest.TxtMainInsuredPhoneInfo, new RecordItemIndex(29));
            repo.ApplicationUnderTest.TxtMainInsuredPhone.PressKeys(App_Phone_Num);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtMainInsuredEmail' at Center.", repo.ApplicationUnderTest.TxtMainInsuredEmailInfo, new RecordItemIndex(30));
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$App_EmailID' with focus on 'ApplicationUnderTest.TxtMainInsuredEmail'.", repo.ApplicationUnderTest.TxtMainInsuredEmailInfo, new RecordItemIndex(32));
            repo.ApplicationUnderTest.TxtMainInsuredEmail.PressKeys(App_EmailID);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FrmApplication.SpanTagSelect' at Center.", repo.FrmApplication.SpanTagSelectInfo, new RecordItemIndex(33));
            repo.FrmApplication.SpanTagSelect.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.Search' at 61;18.", repo.ApplicationUnderTest.SearchInfo, new RecordItemIndex(34));
            repo.ApplicationUnderTest.Search.Click("61;18");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$App_AddressSelection' with focus on 'ApplicationUnderTest.Search'.", repo.ApplicationUnderTest.SearchInfo, new RecordItemIndex(35));
            repo.ApplicationUnderTest.Search.PressKeys(App_AddressSelection);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Return}' with focus on 'ApplicationUnderTest.Search'.", repo.ApplicationUnderTest.SearchInfo, new RecordItemIndex(36));
            repo.ApplicationUnderTest.Search.PressKeys("{Return}");
            Delay.Milliseconds(0);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.TxtFileDesc' at Center.", repo.ApplicationUnderTest.TxtFileDescInfo, new RecordItemIndex(37));
            //repo.ApplicationUnderTest.TxtFileDesc.Click();
            //Delay.Milliseconds(0);
            
            //Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$FileUploadDesc' with focus on 'ApplicationUnderTest.TxtFileDesc'.", repo.ApplicationUnderTest.TxtFileDescInfo, new RecordItemIndex(38));
            //repo.ApplicationUnderTest.TxtFileDesc.PressKeys(FileUploadDesc);
            //Delay.Milliseconds(0);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.UploadFile' at Center.", repo.ApplicationUnderTest.UploadFileInfo, new RecordItemIndex(39));
            ...
            //Report.Log(ReportLevel.Info, "Set value", "Setting attribute Text to '$UploadPath' on item 'Open.Text1148'.", repo.Open.Text1148Info, new RecordItemIndex(41));
            ...
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.BtnUpload' at Center.", repo.ApplicationUnderTest.BtnUploadInfo, new RecordItemIndex(44));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FrmApplication.IAgree' at Center.", repo.FrmApplication.IAgreeInfo, new RecordItemIndex(46));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.BtnSave' at Center.", repo.ApplicationUnderTest.BtnSaveInfo, new RecordItemIndex(48));
            repo.ApplicationUnderTest.BtnSave.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Delay", "Waiting for 10s.", new RecordItemIndex(49));
            Delay.Duration(10000, false);
            
            //Report.Log(ReportLevel.Info, "Wait", "Waiting 15s to exist. Associated repository item: 'ApplicationUnderTest.BtnBackRef'", repo.ApplicationUnderTest.BtnBackRefInfo, new ActionTimeout(15000), new RecordItemIndex(50));
