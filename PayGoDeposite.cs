...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.GL_NPFPolicySubmit_Check' at Center.", repo.ApplicationUnderTest.GL_NPFPolicySubmit_CheckInfo, new RecordItemIndex(9));
            repo.ApplicationUnderTest.GL_NPFPolicySubmit_Check.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 1m to exist. Associated repository item: 'ApplicationUnderTest.LblCompanyName'", repo.ApplicationUnderTest.LblCompanyNameInfo, new ActionTimeout(60000), new RecordItemIndex(10));
